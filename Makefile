...
btt-skr-mini-e3: begin clean gccversion build_btt-skr-mini-e3 sizeafter finished  copy_btt-skr-mini-e3 end
...
build_btt-skr-mini-e3: TARGETFLAGS= -DTARGET_BTT_SKR_MINI_E3 $(DEFINES)
# Set the linker script
build_btt-skr-mini-e3: LDFLAGS +=-T$(ST_LIB)/c_only_md_high_density.ld
build_btt-skr-mini-e3: elf bin lss sym
copy_btt-skr-mini-e3:
	@echo
	@echo "Copying to binaries folder"
	@echo
	cp $(TARGET).bin bootloader_only_binaries/btt-skr-mini-e3.bin
	@echo
